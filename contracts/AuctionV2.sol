...
contract Auction {
   ...
   //Structure to hold the details of a persons
    ...
    function Auction() public payable{    //constructor
        ...
        items[1] = Item({itemId:1,itemTokens:emptyArray}); //ML
        items[2] = Item({itemId:2,itemTokens:emptyArray}); //ML
        //** End code here**/
    }
    ...
    function register() public payable{
        ...
        // ** Start code here. 1 line approximately. **/
        bidders[bidderCount].addr = msg.sender; //ML
        //** End code here. **
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        // ** Start code here. 2 lines approximately. **/
        if (tokenDetails[msg.sender].remainingTokens < _count || tokenDetails[msg.sender].remainingTokens <= 0 ) {revert();} //ML
        if (_itemId > 2) {revert();} //ML
        //** End code here. **
        ...
        // ** Start code here. 1 line approximately. **
        uint balance= tokenDetails[msg.sender].remainingTokens - _count; //ML
        //** End code here. **
    ...
    modifier onlyOwner {
        // ** Start code here. 2 lines approximately. **
        require(msg.sender == beneficiary); //ML
        _;
        //** End code here. **
    }
